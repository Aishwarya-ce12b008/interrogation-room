...
const systemLoaders: Record<string, () => Promise<SystemDefinition>> = {
  interrogation: async () => {
    ...
    return {
      ...
      description: "Two AI detectives interrogate you about a crime. How long can you keep your story straight?",
      icon: "🔦",
      landing: {
  ...
  "milestone-tracker": async () => {
    ...
    return {
      ...
      name: "Aggy's Miles",
      description: "Track Agastya's developmental milestones with a warm, knowledgeable assistant.",
      icon: "👶",
      landing: {
        title: ["AGGY'S", "MILE", "STONES"],
        tagline: "Track developmental milestones with a warm, encouraging assistant who celebrates every achievement.",
  ...
  "smb-analytics": async () => {
    ...
    return {
      id: "smb-analytics",
      name: "SMB Analytics",
      description: "AI-powered business advisor for small Indian merchants. Surfaces insights from real transaction data.",
      icon: "📊",
      landing: {
        title: ["SMB", "ANALYTICS", "AGENT"],
        tagline: "A smart business advisor that knows your books inside out. Pick a merchant to get started.",
        enterButton: "Choose merchant",
        accentColor: "green",
      },
