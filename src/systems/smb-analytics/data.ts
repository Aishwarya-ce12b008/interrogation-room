...
export const merchantCards: MerchantCardData[] = [
  {
    ...
    city: "Delhi",
    description: "Electronics dealer with a mix of retail and B2B credit sales. 80-120 SKUs across TVs, fans, lighting, and appliances.",
    icon: "⚡",
    color: "blue",
  },
  {
    id: "noor-collections",
    name: "Noor Collections",
    business_type: "apparel",
    business_vertical: "retailer",
    city: "Surat",
    description: "Apparel shop with size and color variants. Wholesale and retail, with festive season patterns.",
    icon: "👗",
    color: "purple",
  },
  {
